...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 428.0, 541.0, 36.0, 22.0 ],
					"text" : "+ 0.4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 487.0, 562.0, 36.0, 22.0 ],
					"text" : "+ 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 487.0, 520.0, 33.0, 22.0 ],
					"text" : "* 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 428.0, 513.0, 29.5, 22.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 269.0, 227.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 269.0, 265.0, 72.0, 22.0 ],
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 269.0, 300.0, 45.0, 22.0 ],
					"text" : "adc~ 3"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 269.0, 343.0, 208.0, 146.0 ],
					"prototypename" : "pixl",
					"varname" : "followr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 279.0, 572.0, 168.0, 130.0 ],
					"varname" : "mixfadr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 752.0, 182.0, 199.0, 47.0 ],
					"text" : "They simply work with textures, so we can use with usual jitter workflow."
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 563.0, 181.0, 177.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "sketchr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 57.0, 239.0, 188.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "delayr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 560.0, 6.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 654.0, 55.0, 242.0, 47.0 ],
					"text" : "If there's no any jit.world, I think vizzie is creating a world by itself.\nOtherwise it uses the one we created here."
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 279.0, 708.0, 168.0, 108.0 ],
					"prototypename" : "pixl",
					"varname" : "projectr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 560.0, 37.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 643.0, 343.0, 182.0, 134.0 ],
					"sync" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 560.0, 128.0, 387.0, 22.0 ],
					"text" : "jit.movie @moviefile sunflower.mp4 @vol 0 @loop 1 @output_texture 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 57.0, 45.0, 348.0, 170.0 ],
					"prototypename" : "pixl",
					"varname" : "avplayr",
					"viewvisibility" : 1
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 66.5, 548.5, 288.5, 548.5 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 572.5, 553.5, 338.166666666666686, 553.5 ],
					"order" : 1,
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 496.5, 594.0, 541.666666666666742, 594.0, 541.666666666666742, 171.0, 677.833333333333371, 171.0 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-1::obj-48" : [ "pictctrl[9]", "pictctrl[2]", 0 ],
			...
			"obj-20::obj-17::obj-23" : [ "gswitch2[6]", "gswitch2", 0 ],
			"obj-20::obj-21" : [ "range[19]", "range", 0 ],
			"obj-20::obj-24" : [ "pictctrl[98]", "pictctrl[1]", 0 ],
			"obj-20::obj-26" : [ "Crossfade[1]", "Crossfade", 0 ],
			"obj-20::obj-39" : [ "Operator mode", "Operator mode", 0 ],
			"obj-20::obj-51" : [ "pictctrl[47]", "pictctrl[1]", 0 ],
			"obj-20::obj-56::obj-23" : [ "gswitch2[5]", "gswitch2", 0 ],
